...
const DATA = {
    ...
    struktur: [
        ...
        { nama: 'Kasmawati, S.Pd.', jabatan: 'Kaur Keuangan', foto: 'assets/images/struktur/kasma.png' },
        { nama: 'Rasmi, S.Pd.I.', jabatan: 'Kasi Pelayanan', foto: 'assets/images/struktur/Rasmi.png' },
        { nama: 'Muh. Akbar Umar, S.Pd.', jabatan: 'Kaur TU & Umum', foto: 'assets/images/struktur/Akbar.png' },
        { nama: 'Dahlia', jabatan: 'Kasi Pemerintahan', foto: 'assets/images/struktur/Dahlia.png' },
        { nama: 'Wahyullah Haruna, S.H.', jabatan: 'Kasi Kesejahteraan', foto: 'assets/images/struktur/Wahyu.png' },
        { nama: 'Reski Lestari Ayu Nanda', jabatan: 'Kaur Perencanaan', foto: 'assets/images/struktur/Reski.png' },
        { nama: 'Muh. Nur Salman Saini', jabatan: 'Staff Perencanaan', foto: 'assets/images/struktur' },
        { nama: 'Muh. Vehmil, S.Pd.', jabatan: 'Staff Keuangan', foto: 'assets/images/struktur/Vehmil.png' },
        { nama: 'Ambo Masse', jabatan: 'Kepala Dusun I', foto: 'assets/images/struktur/Ambo.png' },
        { nama: 'H. Sudarmin', jabatan: 'Kepala Dusun II', foto: 'assets/images/struktur/Sudarmin.png' },
    ],
